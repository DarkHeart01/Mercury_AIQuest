  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center w-full min-h-screen bg-background text-foreground relative page-fade-in">
        ...
        {/* Results Section */}
        <div className="mt-6 w-full max-w-md joyride-results overflow-y-auto"
          style={{
            maxHeight: isSearchBarAtBottom ? 'calc(100vh - 150px)' : 'calc(100vh - 250px)',
            paddingBottom: '70px', 
            paddingTop: '20px',
            paddingRight: '30px'
          }}
        >
          ...
          {aiReady && aiSuggestion && (
            <div className="mt-6 p-4 border rounded-lg bg-card text-center max-h-[300px] overflow-y-auto">
